...
const { processConfirmToScope } = require('../controllers/items/processConfirmToUploadController.js');
const { processConfirmToDelete } = require('../controllers/items/processConfirmToDeleteController.js');
const { renderScope } = require('../controllers/items/renderUploadFormController.js');
const { processScope } = require('../controllers/items/processUploadDataController.js');
